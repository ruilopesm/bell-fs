...
class DirectoryResource(HorizontalGroup):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(classes="button-group"):
            yield Button('Enter', id='enter', variant='primary', classes='button-of-group')
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        if button_id == 'enter':
            self.post_message(self.Enter(conver_textual_id_to_uuid(self.id)))
        elif button_id == 'share':
            self.post_message(self.Share(conver_textual_id_to_uuid(self.id)))
        elif button_id == 'delete':
            self.post_message(self.Delete(conver_textual_id_to_uuid(self.id), self.filename))